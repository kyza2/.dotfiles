...
def blend(hex1, hex2, amount):
    hex1 = hex1[1:]
    hex2 = hex2[1:]
    rgb1 = hex_to_rgb(hex1)
    rgb2 = hex_to_rgb(hex2)
    rgb = tuple(int(c1 * amount + c2 * (1 - amount)) for c1, c2 in zip(rgb1, rgb2))
    return rgb_to_hex(rgb)


background_0 = "#0E1319"
background_1 = lighten(background_0, 0.1)
background_2 = lighten(background_0, 0.2)
background_3 = lighten(background_0, 0.4)
...
selection = blend(background_0, blue, 0.85)
...
c.colors.completion.item.selected.fg = foreground_1
...
c.colors.completion.scrollbar.fg = background_3

# Color of the scrollbar in the completion view.
c.colors.completion.scrollbar.bg = background_1
...
c.colors.statusbar.insert.bg = background_1
...
c.colors.statusbar.command.bg = background_0
